	  ...
	  <br />
		...
		<div>
			<label for="login_username">*Birthday:</label> <input type="date"
				...
				title="Please provide your birthday" value="${profile.birthday}" />
		</div>
