...
<body>
	...
	<form id="login" method="post" action="../j_spring_security_check">
		<br /> <span style="color: blue; font-size: 14px;">${requestScope.ApplicationMessage}</span>
		<h1>
			<strong><center>Welcome to the Apartment app</center></strong>
		</h1>
		<h1><center>Please either log in or register to continue</center></h1>
		<div>
		...
		<div>
			<label for="login_password">Password:</label> <input type="password"
				name="j_password" id="login_password" class="field required"
